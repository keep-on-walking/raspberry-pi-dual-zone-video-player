...
### Software
- **Raspberry Pi OS (64-bit) with Desktop** ← Important: NOT Lite version
- Fresh installation recommended
- The desktop is hidden automatically when not in use
...
```bash
git clone https://github.com/keep-on-walking/raspberry-pi-dual-zone-video-player.git
cd raspberry-pi-dual-zone-video-player
```
